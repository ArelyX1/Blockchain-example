const CONTRACT_ADDRESS = "0xa04F2F9fd432bab6Aa20df731B9c438a00152a56";
const ABI = [
  {
    "inputs": [
      {
    ...
    "outputs": [
      {
        ...
        "internalType": "struct StringAttestation.Learner[]",
        "name": "",
        "type": "tuple[]"
      }
    ],
...
// a.href = `https://optimism-sepolia.blockscout.com/tx/${txn.hash}`; //Explorador para Optimism sepolia

//a.href = `https://sepolia.arbiscan.io/tx/${txn.hash}`;
a.href = `https://moonbase.moonscan.io/tx/${txn.hash}`;

  a.innerHTML = "Verifica tu transacción aquí";
  showhash.append(a);
  await txn.wait();
  history.go(0);
}
